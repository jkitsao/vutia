...
function NavPanel({ setSetings, setCustomer, setManage, userDetails }) {
  return (
    <div>
      <nav className="flex flex-col bg-gray-900 w-64 h-full min-h-screen px-4 tex-gray-200">
        ...
        <div className="mt-10 mb-4">
          <ul className="ml-4">
            <li
              className="mb-2 px-4 py-4 text-gray-50 flex flex-row transition-all duration-150  hover:text-black   hover:bg-white  hover:font-bold  rounded-lg"
              onClick={setManage}
            >
              <span>
              ...
              <a href="#">
                <span className="ml-2">Manage shops</span>
              </a>
            </li>
            <li
              className="mb-2 px-4 py-4 text-gray-50 flex flex-row transition-all duration-150  hover:text-black   hover:bg-white  hover:font-bold rounded-lg"
